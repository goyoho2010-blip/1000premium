...
# 💡 [고도화] 실제 2026 수시 모집요강 학과 데이터 기준 정밀 세분화 계열 매핑 (16개 카테고리)
MAJOR_MAPPING = {
    "의·치·한의예 계열": ["의예", "의학", "치의예", "치의학", "치학", "한의예", "한의학"],
    "약학·수의학 계열": ["약학", "제약", "한약", "수의", "수의예"],
    "간호·보건·의료계열": ["간호", "물리치료", "방사선", "안경광학", "언어치료", "응급구조", "임상병리", "작업치료", "치기공", "치위생", "보건"],
    "기계·항공·조선·모빌리티": ["기계", "항공", "우주", "조선", "해양공학", "모빌리티", "자동차", "로봇", "메카트로닉스"],
