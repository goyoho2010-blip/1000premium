...
# 💡 [직관적 정돈] 사범(교육계열)과 예체능/스포츠를 명확히 세분화한 최적 매핑
MAJOR_MAPPING = {
    "의·치·한의예 계열": ["의예", "의학", "치의예", "치의학", "치학", "한의예", "한의학"],
    "약학·수의학 계열": ["약학", "제약", "한약", "수의", "수의예"],
    "간호·보건·의료계열": ["간호", "물리치료", "방사선", "안경광학", "언어치료", "응급구조", "임상병리", "작업치료", "치기공", "치위생", "보건", "재활"],
    "사범(교육계열)": ["교육", "국어교육", "영어교육", "수학교육", "사회교육", "과학교육", "체육교육", "유아교육", "특수교육", "초등교육"],
    "예체능·스포츠 계열": ["체육", "스포츠", "레저", "운동", "사회체육", "체육학", "스포츠과학", "골프", "무도", "미술", "디자인", "음악", "체육"],
    "기계·항공공학·모빌리티": ["기계", "항공공학", "항공우주", "우주", "조선", "해양공학", "모빌리티", "자동차", "로봇", "메카트로닉스"],
    "전기·전자·반도체": ["전기", "전자", "반도체", "디스플레이", "광학"],
    "화학·신소재·에너지": ["화학공학", "화공", "신소재", "재료", "고분자", "에너지", "원자력", "화학"],
    "컴퓨터·AI·소프트웨어·보안": ["컴퓨터", "인공지능", "AI", "소프트웨어", "IT", "정보보안", "보안", "빅데이터", "데이터"],
    "건축·토목·도시·환경": ["건축", "토목", "건설", "도시공학", "환경공학", "지구시스템"],
    "생명·바이오·농림": ["생명과학", "생명공학", "생물", "생화학", "유전", "바이오", "원예", "식물", "산림", "농업", "조경", "동물"],
    "수학·물리·천문·통계": ["수학", "물리", "천문", "우주과학", "통계"],
    "경영·회계·무역·서비스": ["경영", "회계", "세무", "무역", "통상", "벤처", "물류", "항공서비스", "항공운항", "호텔", "관광", "컨벤션", "외식"],
    "경제·금융·소비자": ["경제", "금융", "소비자"],
    "정치·행정·언론·사회": ["정치", "정외", "행정", "언론", "미디어", "신문방송", "사회학", "사회복지"],
    "인문·어문·사학·철학": ["국어국문", "국문", "영어영문", "영문", "중어중문", "중문", "일어일문", "일문", "불어불문", "독어독문", "역사", "사학", "철학", "문화인류", "문헌정보"],
    "자율전공·인문사회·첨단융합": ["자율전공", "자유전공", "자유전공학부", "인문사회", "융합인재", "계열모집"]
}
